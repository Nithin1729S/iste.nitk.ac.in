        ...
        <div className="flex flex-col flex-1">
          {gridData.slice(0, 3).map((color, index) => (
            <div
              ...
              style={ index == 1 ? gridIndex == 0 ? {backgroundColor : "red"} : gridIndex == 1 ? {backgroundColor: "green"} : {backgroundColor: "blue"} : { backgroundColor: color || '#ffffff' }} // Color for cells 1, 2, 3
