...
class Year3 extends Component {
    ...
    componentDidMount() { 
        ...
        baseRequest.get('/obscura/user/year/3', {
            ...
            .then(res => {
                ...
                this.setState({
                    showQuestion: !(numQuestionsSolved === numQuestions[2]),
    ...
    gameOver = () => {
        ...
        const finalScore = Math.min(maxGameScore[2], this.state.gameScore) + this.state.questionScore - 5 * this.state.attemptNumber;
