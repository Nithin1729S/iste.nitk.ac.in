...
class Year1 extends Component {
    state = {
        ...
        gameScore : 0,
        showQuestion: true,
        redirect: false //update this state by checking value from localstorage 
                        // if user has passed year 2 or above : set to false
    }
    componentDidMount() {
    ...
    questionRender = (
        ...
        <>
            ...
            <h3>Remaining Questions : { numQuestions[1] - this.state.numberQuestionSolved }</h3>
            <QuestionWrapper
