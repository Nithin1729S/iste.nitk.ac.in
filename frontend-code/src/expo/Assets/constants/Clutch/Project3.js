    ...
    description: {
                ...
                <ol>
                    <li>
                        ...
                        <a
                            target="_blank"
                            rel="noreferrer"
                            href="https://docs.google.com/spreadsheets/d/1KfQGzFHSGMFy9OxDq0pG3A9auGWP8gV9XLGePMB-B-w/edit#gid=0"
                        >
                            Airfoil Data
                        </a>
                    </li>
        ...
        res: (
            <div>
                <ol>
                    <li>
                        Glider Assembly The assembly of the glider is made in
                        Solidworks.
                        <br />
                        <iframe
