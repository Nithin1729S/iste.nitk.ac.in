...
export default {
	...
	description: {
		aim: (
			<div>
				The aim of this project is to design an aerodynamic glider and analyse
				its aerodynamic aspects.
			</div>
		),
		meth: (
			<div>
				<ol>
					<li>
						...
						analysed using XFLR to find the airfoils for our glider plane. Among
						them SG6043 and NACA 0016 are selected for wing and stabilizers
						respectively. <br />
					...
					<li>
						...
						<ol>
							<li>
								...
								To make the contructable design of the glider the span of the
								wing has been chosen to be 1.2m and the root chord is chosen as
								120mm. <br />
								...
								<iframe
									...
									height="480"
								></iframe>
								<figcaption>Comparison of different types of wings</figcaption>
								<br />
								Similar type of analysis has been done to select Taper Ratio. It
								is observed that the coefficient of lift and drag increases with
								decrease in TR(but the increase is not that significant) when
								dimensionalized, the wing with higher TR will be having higher
								lift and drag force. So an Taper ratio of 0.75 have been chosen.
								<br />
								<iframe
							...
							<li>
								To find the dimensions of glider <br />
								<iframe
									src="https://drive.google.com/file/d/1eln5zKSaXWWhpYq_kUDzzCUmj9eVUdE6/preview"
									width="640"
									height="480"
								></iframe>
								<figcaption>Parameters of the glider</figcaption>
								<br />
								...
								By comparing with the results the parameters which were chosen
								are <br />
								x= 192mm
								<br />
								y= 900mm
						...
						<li>
							...
							fuselage. To design 2d shape we have started with a 900mm x 90mm
							rectangle and changed the leading edge and found that the
							...
							<br />
							Using an elliptic leading edge a fuselage shape is generated in
							the solidworks, then it is divided into sections and by changing
							the dimensions at these sections different shapes have been
							generated and these shapes were analysed using ansys.
							<figure>
								<iframe
							...
							different ellipses and analysed using ansys and it was found that
							the higher the ratio of horizontal radius to vertical ratio higher
							is the drag so the ratio of 1.1 is selected.
						</li>
					</li>
				</ol>
				<img
			...
			<div>
				<ol>
					...
					<li>
						...
						To make the fly stable, the components have been distributed in such
						a way that the COG lies at (243.8, 0, 2.780).
						<iframe
						...
						></iframe>
						<br />
						It can be observed that the curve cuts the x-axis at around 2degree
						AoA, which means that the plane flies stability at around 2degree
						AoA which implies that the plane will have positive lift at stable
						flight. <br />
						Similarly stability analysis has been and the results are been
						recorded in the video In stability analysis there will a disturbance
						given to the plane will check in how much time it will reach
						stability. <br />
						<iframe
		...
		con: (
			<div>
				In this project we have made a simulink model of a plane which can be
				controlled using joystick and can be simulated in flight gear and
				simulink 3D.
				<iframe
				...
				<br />
				But the problem with this model is that it uses parameters of the RCAM
				model, and to make it work for our model the equations of forces and
				moments should be changed but it is not possible with simulations and
				require wind tunnel testing of a physical model.
			</div>
		),
	},
