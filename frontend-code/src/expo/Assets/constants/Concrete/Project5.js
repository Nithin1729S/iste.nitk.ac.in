export default {
	...
	description: {
		...
		meth: (
			<div>
				Dead loads, live loads and wind loads are calculated as per IS 875 part
				1, IS 875 part 2 and IS 875 part 3 respectively and applied on building
				without shear walls and buildings with different shear walls
				configurations using Staad Pro software. The analysis is made on the
				post processing mode which includes maximum resultant nodal
		...
		res: (
			<div>
				Maximum Nodal Displacement Nodes <br />
				will have nodal displacements or degrees of freedom which may include
				translations, rotations, and for special applications, higher order
				derivatives of displacements. When the nodes displace, they will drag
				the elements along in a certain manner dictated by the element
				...
				<br />
				<br /> Increase in Stability with respect to the Building without Shear
				Wall (Design 0)
				<br />
