const project5 = {
    ...
    logo: "https://qph.fs.quoracdn.net/main-qimg-181761ae351b29f3801ab7fa278f457d.webp",
    ...
    description: {
        ...
        meth: (
            <div>
                Introduction
                <br />A shear wall is a structural panel that can resist lateral
                forces acting on it. Lateral forces are those that are parallel
                to the plane of the wall, and are typically wind and seismic
                (earthquake) loads. In simple terms, lateral forces could push
                over parallel structural panels of a building were it not for
                perpendicular shear walls keeping them upright. <br />
                <br />
                <iframe
                ...
                <br />
                <br />
                In this project, the behavior of different shear wall designs
                under wind loads have been analysed. Analysis of G+15 storey
                buildings, mainly consisting of the maximum node displacement
                has been carried out using Staad Pro V8i software. The buildings
                were assumed to be located in NITK. <br />
                <br />
                The shear walls were provided at different locations of the
                building. The analysis of the buildings have been carried out
                using IS 875 - Part 1 for dead loads, IS 875 - Part 2 for live
                loads and IS 875 - Part 3 for wind loads. The size of the
                building in plan is 24 m x 18 m. Height of each storey = 4m,
                Size of Column = 700mm x 700mm, Size of Beam = 500mm x 400mm,
                Shear Wall Thickness = 200mm, Concrete Mix Used = M25, Grade of
                Steel = Fe 415, Solidity Ratio (openings in the building) =
                0.85. All the supports are assumed to be fixed in nature. <br />
                <br />
                ...
                <iframe
                    ...
                    width="640"
                    height="400"
                    title="Shear Wall Configurations"
                ></iframe>{" "}
                <br />
                <br />
                <iframe
                    ...
                    width="640"
                    height="400"
                    title="Shear Wall Configurations2"
                ></iframe>
                <br />
                <br />
                <iframe
                    ...
                    width="640"
                    height="400"
                    title="Shear Wall Configurations3"
                ></iframe>
                <br />
            </div>
        ),
        res: (
            <div>
                ...
                Nodes will have nodal displacements or degrees of freedom which
                may include translations, rotations, and for special
                applications, higher order derivatives of displacements. When
                the nodes displace, they will drag the elements along in a
                certain manner dictated by the element formulation. Therefore it
                is critical to find the maximum resultant nodal displacement for
                any structure to get an idea about the structure’s stability.
                <br />
                <br />
                <iframe
                    ...
                    width="640"
                    height="400"
                    title="Maximum Nodal Displacement"
                ></iframe>
                <br />
                <br />
                Increase in Stability with respect to the Building without Shear
                Wall (Design 0)
                <br />
        ...
        con: (
            <div>
                ...
                <iframe
                    ...
                    width="300"
                    height="200"
                    title="Stability of Shear Wall Configurations"
                ></iframe>
                <iframe
                    ...
                    height="200"
                    style={{ marginLeft: "5%" }}
                    title="Stability of Shear Wall Configurations2"
                ></iframe>
            </div>
        ),
    },
