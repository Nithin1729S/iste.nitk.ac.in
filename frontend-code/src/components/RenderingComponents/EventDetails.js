...
class EventDetails extends React.Component {
  ...
  componentDidMount() {
    ...
    Axios.get(`http://localhost:8000/event/${event_name}`)
      .then((result) => {
        this.setState({
          event: result.data,
        });
        ...
        <div class="row">
          <div class="card hoverable z-depth-3 col s10 push-s1">
            ...
            <div class="card-content">
              ...
              <br />
              <p class="grey-text">
                <i class="inline-icon material-icons">location_on</i>
                {event.venue}
              </p>
              <br />
              <p class="grey-text">
              ...
              <br />
              <p class=" grey-text text-darken-2">{event.publicity_message}</p>
              <br />
              <div class="divider"></div>
              <br />
            </div>
            ...
            <div class="card-action">
              <center>
                <a class="indigo-text" href="{{event.form_url}}">
                  Register Now
                </a>
              </center>
            </div>
