              ...
              <form onSubmit={this.submitHandler}>
                <div className="row">
                  <div className="input-field col s8 push-s2">
                    <i className="form-icon material-icons prefix">event</i>
                    {name}
                    <label>Event name</label>
                  </div>
                  <div className="input-field col s4">
                    <i className="form-icon material-icons prefix">group</i>
                    {no_of_participants}
                ...
                <div className="row">
                  ...
                  <div className="input-field col s4">
                    <i className="form-icon material-icons prefix">person</i>
                    {contacts}
                    <label>Contact</label>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="input-field col s2">
                    <i className="form-icon material-icons prefix">polymer</i>
                    {sigs}
                    <label>Sigs</label>
                  </div>
                </div>
                <div className="row">
                  <div className="input-field col s8 push-s2">
                    <i className="form-icon material-icons prefix">link</i>
                    {form_link}
                ...
                <div className="row">
                  <div className="text-field col s10 push-s2 ">
                    <i className="form-icon material-icons prefix">message</i>
