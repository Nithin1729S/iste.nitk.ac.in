const project2 = {
    ...
    description: {
            ...
            <div>
                ...
                <ol>
                    ...
                    <iframe
                        ...
                        width="640"
                        height="480"
                        title="ROS and Gazebo Flowchart"
                    ></iframe>
                </ol>
        ...
        con: (
            <div>
                1. Eye-tracking was implemented with an average execution time
                of around 40 milliseconds when tested on an Intel Core i7-7500U
                processor operating at 2.70 GHz.
                <br /> 2. If the blinks are consecutive within 750 milliseconds,
                then the system is turned on/off. <br />
                3. ROS and Gazebo simulation of the wheelchair was successfully
                implemented.
                <br /> 4. For the CNN model, K Fold Cross Validation gave a
                training Loss of 0.0959 and Validation Loss of 0.0111.
                <br />
                Video demo :
                <br />
                ...
                ></iframe>
                <br />
                <br /> Improving the accuracy of the convolutional neural
                network used and hardware implementation of the model using
                microcontrollers.
            </div>
        ),
    },
